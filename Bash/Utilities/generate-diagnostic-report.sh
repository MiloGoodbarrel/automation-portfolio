...
#
# DESCRIPTION
#   Generates macOS system diagnostic report and emails to support
#   Supports both Apple Mail and Microsoft Outlook
#   Runs sysdiagnose and attaches output to email template
#
# USAGE
#   ./generate-diagnostic-report.sh
#
# NOTES
#   - Requires mail client (Apple Mail or Outlook)
#   - Creates diagnostic in /var/tmp
#   - Prompts user for issue details in email template
#   - Update support email address before deployment
#
